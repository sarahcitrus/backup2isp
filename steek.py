...
class Steek:
  ...
  def writeToPath ( self, path, buf, offset ) :
    ...
    initform = { 'name': 'init', 'data' : "13000" } # lowest level dir, 13000 is 'My Documents', 18000 is 'My Bookmarks', 19000 is 'My other files'
    option1 = { 'name': 'option1', 'data' : "O" } # O (not zero) is overwrite, anything else just seems to create copies
